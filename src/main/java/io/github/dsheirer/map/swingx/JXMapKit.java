...
import io.github.dsheirer.map.swingx.mapviewer.DefaultWaypoint;
...
import io.github.dsheirer.map.swingx.mapviewer.Waypoint;
import io.github.dsheirer.map.swingx.mapviewer.WaypointPainter;
import io.github.dsheirer.map.swingx.mapviewer.bmng.CylindricalProjectionTileFactory;
import io.github.dsheirer.map.swingx.painter.AbstractPainter;
import io.github.dsheirer.map.swingx.painter.CompoundPainter;
...
public class JXMapKit extends JPanel
{
	...
	public JXMapKit()
	{
		...
		try
		{
			Icon minusIcon = new ImageIcon(getClass().getResource("/io/github/dsheirer/map/swingx/mapviewer/resources/minus.png"));
			this.zoomOutButton.setIcon(minusIcon);
			this.zoomOutButton.setText("");
			Icon plusIcon = new ImageIcon(getClass().getResource("/io/github/dsheirer/map/swingx/mapviewer/resources/plus.png"));
...
//				Point2D centerpos = map.getTileFactory().geoToPixel(mapCenterPosition, map.getZoom());
	...
	private void initComponents()
	{
		...
		zoomInButton.setIcon(new javax.swing.ImageIcon(getClass().getResource(
			"/io/github/dsheirer/map/swingx/mapviewer/resources/plus.png")));
		...
		zoomOutButton.setIcon(new javax.swing.ImageIcon(getClass().getResource(
			"/io/github/dsheirer/map/swingx/mapviewer/resources/minus.png")));
